        ...
        <div className="min-h-screen bg-slate-50">
            <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm backdrop-blur-md bg-white/90">
                <div className="max-w-3xl mx-auto px-4 md:px-8 h-14 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-lg font-bold text-slate-900 tracking-tight">Ajukan Survey Gorden Kantor</h1>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-3xl mx-auto px-4 md:px-8 py-8 pb-32">
                <div className="space-y-6">
                    <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider pl-1">Nama Perusahaan/PIC</label>
                                <Input
                                    placeholder="Nama Perusahaan atau PIC"
                                    className="h-12 bg-slate-50 border-slate-200 focus-visible:ring-blue-500 rounded-xl placeholder:text-slate-300"
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <label className="text-xs font-bold text-slate-500 uppercase tracking-wider pl-1">Alamat Kantor</label>
                                <Input
                    ...
                    <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 space-y-4">
                        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                            <div className="p-2 bg-blue-100 rounded-lg text-blue-600"><Calendar className="h-5 w-5" /></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    type="date"
                                    className="h-12 bg-slate-50 border-slate-200 focus-visible:ring-blue-500 rounded-xl cursor-pointer"
                                    value={surveyDate}
                            ...
                            <div className="space-y-2">
                                ...
                                {getAvailableTimeSlots().length === 0 && surveyDate === new Date().toISOString().split('T')[0] ? (
                                    ...
                                    <select
                                        className="h-12 w-full bg-slate-50 border border-slate-200 focus:ring-blue-500 rounded-xl px-4 text-slate-700"
                                        value={surveyTime}
                    ...
                    <Button
                        ...
                        className="w-full h-14 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-bold text-lg shadow-xl shadow-blue-600/30 hover:shadow-2xl hover:shadow-blue-600/50 flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.01] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isSubmitting ? (
                            <>Mengajukan...</>
                        ) : (
